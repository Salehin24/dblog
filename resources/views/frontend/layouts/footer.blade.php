    <footer>
        ...
        <div class="row">
            ...
            <div class="footer-section">
              ...
              <ul class="footer-section-content">
                <li class="footer-section-content-response">
                  <img
                    src="{{ url('public/frontend/img/webp/profile-picture2_2x.html') }}"
                    alt="Profile Picture"
                    >
                  <div class="footer-section-content-response-wrapper">
                    <h4>
                      <span class="response-author">Jobby Foster</span> in 
                      <a href="#" class="response-subject light-link" title="Subject Response">
                        Want to learn Javascript in 2022?
                      </a>
                    </h4>
                    <p class="mt-2">Love this guy and his dog, really nice work!</p>
                  </div>
                </li>

                <li class="footer-section-content-response">
                  <img
                    src="{{ url('public/frontend/img/webp/profile-picture3_2x.html') }}" 
                    alt="Profile Picture"
                    >
                  <div class="footer-section-content-response-wrapper">
                    <h4>
                    ...
                    <p class="mt-2">Love the way you did the background image man.</p>
                  </div>
                </li>

                <li class="footer-section-content-response">
                  <img
                    src="{{ url('public/frontend/img/webp/profile-picture4_2x.html') }}" 
                    alt="Profile Picture"
                    >
                  <div class="footer-section-content-response-wrapper">
                    <h4>
                    ...
                    <p class="mt-2">Really nice style. I need to take note for drawing people!</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="footer-section">
              ...
              <ul class="footer-section-content">
                ...
                <li class="footer-section-content-twitt">
                  ...
                  <p class="mt-2">She's climbing #50Peaks in 50 states in 50 days. Meet 
          ...
          <div class="col-md-4 col-xs-12">
            <div class="footer-section border-bottom">
              <img
                class="footer-section-title-img"
                src="{{ url('public/frontend/img/webp/logo-grey_2x.html') }}"
                alt="Logo"
                width="32"
                height="32"
                >
              <div class="footer-section-content">
                <p class="footer-section-content-about">
            ...
            <div class="footer-section">
              ...
              <div class="footer-section-content">
                <p>Stay up to do date with my posts, subscribe to newsletter:</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <div class="copyright d-flex align-items-center justify-content-between flex-column flex-md-row-reverse ">
              <ul class="d-flex">
              ...
              <p>&copy; Theme by <a href="#" title="">PrestaHome</a>. All
                Rights Reserved.</p>
            </div>
          </div>
        </div>
